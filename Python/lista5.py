...
Texto = '''213752 216732 221063 221545 225583 229133 230648 233222
236043 237330 239636 240138 242123 246224 249183 252936
254711 257200 257607 261424 263814 266794 268649 273050
275001 277606 278997 283331 287104 287953 289137 291591
292559 292946 295180 295566 297529 300400 304707 306931
...
while(True):
    ...
    for x in range(cont):
        teste = str(Texto[x])
        if Consecutivos(teste) == True or Par(teste) == False or Ult_iguais(teste) == True:
            Texto.remove(teste)
            conta = 0
            break
        if Consecutivos(teste) == False and Par(teste) == True and Ult_iguais(teste) == False:
            conta += 1
    if conta == cont:
        break
